...
/**
 * This class demonstrates how to integrate a custom WMTS-Layer with advanced settings.
 *
 * TODO: Just use BkgTopPlusOpen here from map package?
 */
class BkgTopPlusOpen extends WMTS {
    constructor(options: { layer: "web" | "web_grau" | "web_light" }) {
        ...
        super({
            url: `https://sgx.geodatenzentrum.de/wmts_topplus_open/tile/1.0.0/${options.layer}/{Style}/{TileMatrixSet}/{TileMatrix}/{TileRow}/{TileCol}.png`,
            layer: options.layer,
