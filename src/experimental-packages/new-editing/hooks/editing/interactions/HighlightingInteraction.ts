...
export class HighlightingInteraction extends BaseInteraction<HighlightingOptions, Data> {
    protected override startInteraction(options: HighlightingOptions): Data {
        const { feature, highlightOptions } = options;
