...
import { GroupSublayer } from "../api/layers/GroupLayer";
...
export class GroupSublayersCollectionImpl
    implements SublayersCollection<GroupSublayer>
{
    #sublayers: GroupSublayer[];

    constructor(sublayers: GroupSublayer[]) {
        this.#sublayers = sublayers;
    }
    ...
    getSublayers(_options?: LayerRetrievalOptions | undefined): GroupSublayer[] {
        // NOTE: options are ignored because layers are always ordered at this time.
        return this.#sublayers.slice();
    }
     ...
     * NOTE: Do not modify directly!
     */
    __getRawSublayers(): GroupSublayer[] {
        return this.#sublayers;
    }
}
