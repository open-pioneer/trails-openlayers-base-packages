...
it.todo("should successfully create position styles on `top-left` without gap", async () => {
...
it.todo(
    "should successfully create position styles on `top-left` with horizontalGap and verticalGap",
    async () => {
        const position: MapAnchorPosition = "top-left";
        ...
        expect(styleProps.maxW).toBe(
            "calc((100%) - (var(--map-padding-left) + 50px) - 0px - 50px)"
        );
    }
);

it.todo(
    "should successfully create position styles on `bottom-right` with horizontalGap and verticalGap",
    async () => {
        ...
        expect(styleProps.maxW).toBe(
            "calc((100%) - 0px - (var(--map-padding-right) + 50px) - 50px)"
        );
    }
);

it.todo("should successfully create position styles on `bottom-h-center` without gap", async () => {
