...
it("expect url is created correctly on vector-source", async () => {
    ...
    const queryFeatures = async (fullUrl: string): Promise<_FeatureResponse> => {
