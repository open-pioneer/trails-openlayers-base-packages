...
import { useDeclarativeFormContext, usePropertyFormContext } from "../../context/usePropertyFormContext";
...
export function PropertyForm(props: PropertyFormProps): ReactElement {
    ...
    return (
        <TitledSection>
            <Flex className="editor__property-form" direction={"column"} flex={1}>
                ...
                {hasRequiredFields && (
                <Text fontSize={"sm"} aria-hidden="true" textAlign={"right"} paddingRight={2} mb={100}>
